    ...
    <div className="min-h-screen font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-50/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="text-xl font-monda tracking-tight text-slate-900">
            interlinked.dev
          </div>

          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            <a href="#solutions" className="hover:text-blue-600 transition-colors">Lösungen</a>
            <a href="#process" className="hover:text-blue-600 transition-colors">Arbeitsweise</a>
            <a href="#founder" className="hover:text-blue-600 transition-colors">Über uns</a>
          </div>

          <a
            href="mailto:contact@interlinked.dev"
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-16">
                <button className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white transition-all bg-blue-600 rounded-full hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/20 active:scale-[0.98]">
                  Kostenlose Erstberatung
                </button>
                <button className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-slate-700 transition-all bg-white border border-slate-200 rounded-full hover:bg-slate-50 hover:border-slate-300 active:scale-[0.98]">
                  So funktioniert's
                </button>
              </div>

              {/* Trust Stats */}
              <div className="grid grid-cols-3 gap-8 border-t border-slate-200 pt-8 max-w-2xl">
                <div>
                  <div className="text-3xl font-bold text-slate-900 mb-1">10+ Jahre</div>
                  <div className="text-sm font-medium text-slate-500 uppercase tracking-wide">Engineering-Erfahrung</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-slate-900 mb-1">50+</div>
                  <div className="text-sm font-medium text-slate-500 uppercase tracking-wide">Systeme implementiert</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-slate-900 mb-1">100%</div>
                  <div className="text-sm font-medium text-slate-500 uppercase tracking-wide">DSGVO-konform</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className="bg-slate-800 rounded-3xl p-10 flex flex-col justify-center text-white shadow-xl overflow-hidden relative group min-h-[360px]">
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div>
                    <a href="https://cal.com/marc-serafin/30min" target="_blank" className="inline-block px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-900/20">
                      Kostenlose Erstberatung
                    </a>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-2">
              <div className="text-xl font-bold font-jura tracking-tight text-slate-900 mb-6">
                interlinked.dev
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-600">
                ...
                <li><a href="#" className="hover:text-blue-600 transition-colors">AGB</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-600">
                ...
                <li className="text-slate-400">München, Deutschland</li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-slate-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-sm text-slate-400">
              © 2026 Interlinked.dev. München, Deutschland.
            </div>
