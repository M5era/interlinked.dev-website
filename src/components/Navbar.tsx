            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-50/80 backdrop-blur-md border-b border-slate-200">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
                        <a href="#solutions" onClick={(e) => handleScroll(e, "#solutions")} className="hover:text-blue-600 transition-colors">Lösungen</a>
                        <a href="#work" onClick={(e) => handleScroll(e, "#work")} className="hover:text-blue-600 transition-colors">Arbeitsweise</a>
                        <a href="#founder" onClick={(e) => handleScroll(e, "#founder")} className="hover:text-blue-600 transition-colors">Über uns</a>
                        <a
                            href="#contact"
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden border-t border-slate-200 bg-white shadow-xl">
                        <div className="px-6 py-8 flex flex-col gap-6 text-lg font-medium text-slate-900">
                            <a href="#solutions" onClick={(e) => handleScroll(e, "#solutions")}>Lösungen</a>
                            <a href="#work" onClick={(e) => handleScroll(e, "#work")}>Arbeitsweise</a>
                            <a href="#founder" onClick={(e) => handleScroll(e, "#founder")}>Über uns</a>
                            <a
                                href="#contact"
                                onClick={(e) => handleScroll(e, "#contact")}
